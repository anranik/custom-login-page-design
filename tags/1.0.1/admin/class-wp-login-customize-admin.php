...
class Wp_Login_Customize_Admin {
	...
	public function __construct( $plugin_name, $version ) {
        ...
        $this->wp_login_customization_options = get_option($this->plugin_name);
...
//login background
    private function wp_login_customization_login_bg_css(){
        if(isset($this->wp_login_customization_options['login_bg_id']) && !empty($this->wp_login_customization_options['login_bg_id'])){
            $login_bg = wp_get_attachment_image_src($this->wp_login_customization_options['login_bg_id'], 'bg-size');
            $login_bg_url = $login_bg[0];
            $bg_size = $this->wp_login_customization_options['bg_size'];
...
//login logo
    private function wp_login_customization_login_logo_css(){
        if(isset($this->wp_login_customization_options['login_logo_id']) && !empty($this->wp_login_customization_options['login_logo_id'])){
            $login_logo = wp_get_attachment_image_src($this->wp_login_customization_options['login_logo_id'], 'logo-size');
    ...
    private function wp_login_csutomization_login_form_background_color(){
        if(isset($this->wp_login_customization_options['login_form_background_color']) && !empty($this->wp_login_customization_options['login_form_background_color']) ){
            $login_form_background_color  = "body.login{ background-color:".$this->wp_login_customization_options['login_form_background_color']."!important;}";
    ...
    private function wp_login_csutomization_login_background_color(){
        if(isset($this->wp_login_customization_options['login_background_color']) && !empty($this->wp_login_customization_options['login_background_color']) ){
            $background_color_css  = "body.login div#login form#loginform{ background-color:".$this->wp_login_customization_options['login_background_color']."!important;}";
...
// Get Button and links color is set and different from #00A0D2 return it's css
    ...
    public function wp_login_custiomization_login_css(){
        if(!empty($this->wp_login_customization_options['login_logo_id'])
            ||
            !empty($this->wp_login_customization_options['login_bg_id'])
            ||
